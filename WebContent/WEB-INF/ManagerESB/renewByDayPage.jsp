...
<body class="body">
	<div class="tableDiv">
		...
		<h1>
			按天趋势表
			<lable>总用户：${otherData.listSize}
			付费用户：${otherData.RenewListNum} 付费率：${otherData.RenewScale}%
			续费用户：${otherData.TwoRenewListNum} 续费率：${otherData.TwoRenewScale}%
			总收入：${otherData.RenewMoney}</lable>
		</h1>
		<table>
			<tr>
				<th>日期</th>

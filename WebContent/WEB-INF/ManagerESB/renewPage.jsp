	...
	<div class="tableDiv">
		...
		<table>
			<tr>
				<th>删除</th>
				<th>账户</th>
				<th id="registerTimeThId" title="点击排序">续费金额</th>
				<th id="expirationTimeThId" title="点击排序">续费时间</th>
				<th id="loginNumberThId" title="点击排序">代理账户</th>
				<th id="loginTimeThId" title="点击排序">是否结算</th>
				<th id="surplusDayThId" title="点击排序">结算时间</th>
			</tr>
			<s:iterator var="item" value="payRecordList">
				<tr>
					<td><a class="deleteUser" href="#"
						value="<s:property value="#item.id" />">删除</a></td>
